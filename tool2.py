...
API_DEFINITIONS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "description": (
            "Summarizes a list of objects. The logic of how to summarize a particular "
            "object type is an internal implementation detail."
        ),
        "arguments": [
            {
    ...
    {"name": "get_sprint_id", "description": "Returns the ID of the current sprint", "arguments": []},
    {
    ...
    {"name": "who_am_i", "description": "Returns the ID of the current user", "arguments": []},
    {
        "name": "is_empty",
        ...
        "arguments": [
            {
                "argument_name": "applies_to_part",
                "argument_description": (
                    "The part that the work applies to. Specifying a part is required when "
                    "creating tickets and issues. Note: REQUIRED"
                ),
                "argument_type": "array of strings",
            },
            {
    ...
    {"name": "get_current_date", "description": "Get's the current date", "arguments": []},
]
...
__all__ = ["API_DEFINITIONS", "get_api_by_name"]